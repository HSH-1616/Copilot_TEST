...
if (ivUser != null && !ivUser.isEmpty() && !"Unauthenticated".equalsIgnoreCase(ivUser)){
	userId = ivUser;
	isSSO = true;	
}
%>
...
<head>
    ...
    <title>비밀번호 변경 - IAM Portal</title>
    ...
    <style>
        ...
        .input-wrapper i { position: absolute; left: 14px; top: 50%; transform: translateY(-50%); color: #64748b; font-size: 0.9rem; }
        .input-field {
        ...
        .input-field[readonly] { background: rgba(0, 0, 0, 0.2); color: #64748b; }
    ...
    <div id="pwFormSection" class="login-container">
        ...
        <div class="form-group">
            ...
            <div class="input-wrapper">
                ...
                <input v-model="empNo" type="text" class="input-field" :readonly="isSSO" placeholder="사번 입력">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-wrapper">
                ...
                <input v-model="oldPw" type="password" class="input-field" placeholder="현재 비밀번호">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-wrapper">
                ...
                <input v-model="confirmPw" type="password" class="input-field" placeholder="새 비밀번호 다시 입력">
            </div>
        </div>

        <button type="button" class="btn-primary" :disabled="pwdChangeBtnDisabled || isLoading" @click="pwChange">
